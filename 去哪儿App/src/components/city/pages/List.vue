    ...
    <div class="container" ref="container">
      ...
      <div class="wraper">
        ...
        <div class="hot">
          <h2>热门城市</h2>
          <ul>
            <li @click="Changecity(item.name)" v-for="(item,key) in hotCities" :key="item.id">{{item.name}}</li>
          </ul>
        </div>
        <!--sort部分-->
        <div class="sort">
        ...
        <div class="list">
          <div class="containers arralist" :ref="key" v-for="(value,key) in cities" :key="key">
            ...
            <ul>
              <li @click="Changecity(item.name)" v-for="item in value" :key="item.id"><span>{{item.name}}</span></li>
            </ul>
          </div>
        </div>
      </div>
